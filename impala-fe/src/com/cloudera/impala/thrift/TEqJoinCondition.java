...
public class TEqJoinCondition implements org.apache.thrift.TBase<TEqJoinCondition, TEqJoinCondition._Fields>, java.io.Serializable, Cloneable {
  ...
  public com.cloudera.impala.thrift.TExpr left; // required
  public com.cloudera.impala.thrift.TExpr right; // required
  ...
  public TEqJoinCondition(
    com.cloudera.impala.thrift.TExpr left,
    com.cloudera.impala.thrift.TExpr right)
  {
    this();
    this.left = left;
    this.right = right;
  ...
  public TEqJoinCondition(TEqJoinCondition other) {
    if (other.isSetLeft()) {
      this.left = new com.cloudera.impala.thrift.TExpr(other.left);
    }
    if (other.isSetRight()) {
      this.right = new com.cloudera.impala.thrift.TExpr(other.right);
    }
  }
  ...
  public com.cloudera.impala.thrift.TExpr getLeft() {
    return this.left;
  }

  public TEqJoinCondition setLeft(com.cloudera.impala.thrift.TExpr left) {
    this.left = left;
    return this;
  }
  ...
  public com.cloudera.impala.thrift.TExpr getRight() {
    return this.right;
  }

  public TEqJoinCondition setRight(com.cloudera.impala.thrift.TExpr right) {
    this.right = right;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case LEFT:
      if (value == null) {
        ...
        setLeft((com.cloudera.impala.thrift.TExpr)value);
      }
      break;
    ...
    case RIGHT:
      if (value == null) {
        ...
        setRight((com.cloudera.impala.thrift.TExpr)value);
      }
      break;
  ...
  public int compareTo(TEqJoinCondition other) {
    ...
    TEqJoinCondition typedOther = (TEqJoinCondition)other;
        ...
        switch (schemeField.id) {
          case 1: // LEFT
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.left = new com.cloudera.impala.thrift.TExpr();
          ...
          case 2: // RIGHT
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.right = new com.cloudera.impala.thrift.TExpr();
