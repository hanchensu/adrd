...
public class TDataPartition implements org.apache.thrift.TBase<TDataPartition, TDataPartition._Fields>, java.io.Serializable, Cloneable {
  ...
  public List<com.cloudera.impala.thrift.TExpr> partition_exprs; // optional
  ...
  private _Fields optionals[] = {_Fields.PARTITION_EXPRS};
  ...
  public TDataPartition setPartition_exprs(List<com.cloudera.impala.thrift.TExpr> partition_exprs) {
  ...
  public int compareTo(TDataPartition other) {
    ...
    TDataPartition typedOther = (TDataPartition)other;
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = TPartitionType.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_exprs = new ArrayList<com.cloudera.impala.thrift.TExpr>(_list0.size);
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  com.cloudera.impala.thrift.TExpr _elem2; // required
                  _elem2 = new com.cloudera.impala.thrift.TExpr();
                  _elem2.read(iprot);
                  struct.partition_exprs.add(_elem2);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.partition_exprs != null) {
        if (struct.isSetPartition_exprs()) {
          oprot.writeFieldBegin(PARTITION_EXPRS_FIELD_DESC);
          {
            ...
            for (com.cloudera.impala.thrift.TExpr _iter3 : struct.partition_exprs)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetPartition_exprs()) {
        {
          ...
          for (com.cloudera.impala.thrift.TExpr _iter4 : struct.partition_exprs)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.partition_exprs = new ArrayList<com.cloudera.impala.thrift.TExpr>(_list5.size);
          for (int _i6 = 0; _i6 < _list5.size; ++_i6)
          {
            com.cloudera.impala.thrift.TExpr _elem7; // required
            _elem7 = new com.cloudera.impala.thrift.TExpr();
            _elem7.read(iprot);
            struct.partition_exprs.add(_elem7);
          }
        }
        struct.setPartition_exprsIsSet(true);
      }
