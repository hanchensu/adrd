...
public class TCreateTableLikeParams implements org.apache.thrift.TBase<TCreateTableLikeParams, TCreateTableLikeParams._Fields>, java.io.Serializable, Cloneable {
  ...
  public TTableName src_table_name; // required
   ...
   * @see TFileFormat
   */
  public TFileFormat file_format; // optional
  ...
  private _Fields optionals[] = {_Fields.FILE_FORMAT,_Fields.COMMENT,_Fields.LOCATION};
  ...
  public TCreateTableLikeParams(TCreateTableLikeParams other) {
    ...
    if (other.isSetSrc_table_name()) {
      this.src_table_name = new TTableName(other.src_table_name);
    }
  ...
  public TCreateTableLikeParams setTable_name(TTableName table_name) {
    this.table_name = table_name;
    return this;
  }
  ...
  public TCreateTableLikeParams setSrc_table_name(TTableName src_table_name) {
    this.src_table_name = src_table_name;
    return this;
  }
   ...
   * @see TFileFormat
   */
  public TCreateTableLikeParams setFile_format(TFileFormat file_format) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SRC_TABLE_NAME:
      if (value == null) {
        ...
        setSrc_table_name((TTableName)value);
      }
      break;
  ...
  public int compareTo(TCreateTableLikeParams other) {
    ...
    TCreateTableLikeParams typedOther = (TCreateTableLikeParams)other;
    ...
    lastComparison = Boolean.valueOf(isSetSrc_table_name()).compareTo(typedOther.isSetSrc_table_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSrc_table_name()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.src_table_name, typedOther.src_table_name);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TCreateTableLikeParams struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // SRC_TABLE_NAME
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.src_table_name = new TTableName();
