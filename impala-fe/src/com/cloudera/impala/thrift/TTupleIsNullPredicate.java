...
public class TTupleIsNullPredicate implements org.apache.thrift.TBase<TTupleIsNullPredicate, TTupleIsNullPredicate._Fields>, java.io.Serializable, Cloneable {
  ...
  public TTupleIsNullPredicate(TTupleIsNullPredicate other) {
    if (other.isSetTuple_ids()) {
      List<Integer> __this__tuple_ids = new ArrayList<Integer>();
  ...
  public int compareTo(TTupleIsNullPredicate other) {
    ...
    TTupleIsNullPredicate typedOther = (TTupleIsNullPredicate)other;

    lastComparison = Boolean.valueOf(isSetTuple_ids()).compareTo(typedOther.isSetTuple_ids());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTuple_ids()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.tuple_ids, typedOther.tuple_ids);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
