...
public class TRuntimeProfileTree implements org.apache.thrift.TBase<TRuntimeProfileTree, TRuntimeProfileTree._Fields>, java.io.Serializable, Cloneable {
  ...
  public TRuntimeProfileTree(TRuntimeProfileTree other) {
    if (other.isSetNodes()) {
      List<TRuntimeProfileNode> __this__nodes = new ArrayList<TRuntimeProfileNode>();
  ...
  public int compareTo(TRuntimeProfileTree other) {
    ...
    TRuntimeProfileTree typedOther = (TRuntimeProfileTree)other;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.nodes = new ArrayList<TRuntimeProfileNode>(_list68.size);
                for (int _i69 = 0; _i69 < _list68.size; ++_i69)
                {
                  TRuntimeProfileNode _elem70; // required
                  _elem70 = new TRuntimeProfileNode();
                  _elem70.read(iprot);
                  struct.nodes.add(_elem70);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRuntimeProfileTree struct) throws org.apache.thrift.TException {
      ...
      if (struct.nodes != null) {
        oprot.writeFieldBegin(NODES_FIELD_DESC);
        {
          ...
          for (TRuntimeProfileNode _iter71 : struct.nodes)
          {
            _iter71.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class TRuntimeProfileTreeTupleScheme extends TupleScheme<TRuntimeProfileTree> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TRuntimeProfileTree struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (TRuntimeProfileNode _iter72 : struct.nodes)
        {
          _iter72.write(oprot);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TRuntimeProfileTree struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.nodes = new ArrayList<TRuntimeProfileNode>(_list73.size);
        for (int _i74 = 0; _i74 < _list73.size; ++_i74)
        {
          TRuntimeProfileNode _elem75; // required
          _elem75 = new TRuntimeProfileNode();
          _elem75.read(iprot);
          struct.nodes.add(_elem75);
        }
      }
      struct.setNodesIsSet(true);
    }
