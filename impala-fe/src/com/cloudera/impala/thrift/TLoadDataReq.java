...
public class TLoadDataReq implements org.apache.thrift.TBase<TLoadDataReq, TLoadDataReq._Fields>, java.io.Serializable, Cloneable {
  ...
  public TLoadDataReq setTable_name(TTableName table_name) {
    this.table_name = table_name;
    return this;
  }
  ...
  public TLoadDataReq setPartition_spec(List<TPartitionKeyValue> partition_spec) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_spec = new ArrayList<TPartitionKeyValue>(_list112.size);
                for (int _i113 = 0; _i113 < _list112.size; ++_i113)
                {
                  TPartitionKeyValue _elem114; // required
                  _elem114 = new TPartitionKeyValue();
                  _elem114.read(iprot);
      ...
      if (struct.partition_spec != null) {
        if (struct.isSetPartition_spec()) {
          oprot.writeFieldBegin(PARTITION_SPEC_FIELD_DESC);
          {
            ...
            for (TPartitionKeyValue _iter115 : struct.partition_spec)
            {
      ...
      if (struct.isSetPartition_spec()) {
        {
          ...
          for (TPartitionKeyValue _iter116 : struct.partition_spec)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.partition_spec = new ArrayList<TPartitionKeyValue>(_list117.size);
          for (int _i118 = 0; _i118 < _list117.size; ++_i118)
          {
            TPartitionKeyValue _elem119; // required
            _elem119 = new TPartitionKeyValue();
            _elem119.read(iprot);
