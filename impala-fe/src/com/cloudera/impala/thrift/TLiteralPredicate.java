...
public class TLiteralPredicate implements org.apache.thrift.TBase<TLiteralPredicate, TLiteralPredicate._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TLiteralPredicate other) {
    ...
    TLiteralPredicate typedOther = (TLiteralPredicate)other;
    ...
    lastComparison = Boolean.valueOf(isSetIs_null()).compareTo(typedOther.isSetIs_null());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_null()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.is_null, typedOther.is_null);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
