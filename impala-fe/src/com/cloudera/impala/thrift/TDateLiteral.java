...
public class TDateLiteral implements org.apache.thrift.TBase<TDateLiteral, TDateLiteral._Fields>, java.io.Serializable, Cloneable {
  ...
  public TDateLiteral setValue(long value) {
    this.value = value;
    setValueIsSet(true);
    return this;
  }
  ...
  public int compareTo(TDateLiteral other) {
    ...
    TDateLiteral typedOther = (TDateLiteral)other;
