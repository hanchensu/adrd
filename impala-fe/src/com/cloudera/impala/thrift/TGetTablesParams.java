...
public class TGetTablesParams implements org.apache.thrift.TBase<TGetTablesParams, TGetTablesParams._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.DB,_Fields.PATTERN,_Fields.SESSION};
  ...
  public TGetTablesParams setSession(TSessionState session) {
  ...
  public int compareTo(TGetTablesParams other) {
    ...
    TGetTablesParams typedOther = (TGetTablesParams)other;
