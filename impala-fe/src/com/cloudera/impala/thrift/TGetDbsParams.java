...
public class TGetDbsParams implements org.apache.thrift.TBase<TGetDbsParams, TGetDbsParams._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.PATTERN,_Fields.SESSION};
  ...
  public TGetDbsParams setSession(TSessionState session) {
  ...
  public int compareTo(TGetDbsParams other) {
    ...
    TGetDbsParams typedOther = (TGetDbsParams)other;
