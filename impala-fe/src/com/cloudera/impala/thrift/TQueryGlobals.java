...
public class TQueryGlobals implements org.apache.thrift.TBase<TQueryGlobals, TQueryGlobals._Fields>, java.io.Serializable, Cloneable {
  ...
  public TQueryGlobals setUser(String user) {
    this.user = user;
    return this;
  }
  ...
  public int compareTo(TQueryGlobals other) {
    ...
    TQueryGlobals typedOther = (TQueryGlobals)other;
