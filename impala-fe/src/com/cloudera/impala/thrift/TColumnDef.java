...
public class TColumnDef implements org.apache.thrift.TBase<TColumnDef, TColumnDef._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TColumnDef other) {
    ...
    TColumnDef typedOther = (TColumnDef)other;

    lastComparison = Boolean.valueOf(isSetColumnDesc()).compareTo(typedOther.isSetColumnDesc());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetColumnDesc()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.columnDesc, typedOther.columnDesc);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
