...
public class TGetDbsResult implements org.apache.thrift.TBase<TGetDbsResult, TGetDbsResult._Fields>, java.io.Serializable, Cloneable {
  ...
  public TGetDbsResult(TGetDbsResult other) {
    if (other.isSetDbs()) {
      List<String> __this__dbs = new ArrayList<String>();
      for (String other_element : other.dbs) {
        __this__dbs.add(other_element);
      }
  ...
  public int compareTo(TGetDbsResult other) {
    ...
    TGetDbsResult typedOther = (TGetDbsResult)other;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.dbs = new ArrayList<String>(_list8.size);
                for (int _i9 = 0; _i9 < _list8.size; ++_i9)
                {
                  String _elem10; // required
                  _elem10 = iprot.readString();
                  struct.dbs.add(_elem10);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.dbs = new ArrayList<String>(_list13.size);
          for (int _i14 = 0; _i14 < _list13.size; ++_i14)
          {
            String _elem15; // required
            _elem15 = iprot.readString();
            struct.dbs.add(_elem15);
          }
        }
        struct.setDbsIsSet(true);
      }
