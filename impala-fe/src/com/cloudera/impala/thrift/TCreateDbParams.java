...
public class TCreateDbParams implements org.apache.thrift.TBase<TCreateDbParams, TCreateDbParams._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.COMMENT,_Fields.LOCATION,_Fields.IF_NOT_EXISTS};
  ...
  public int compareTo(TCreateDbParams other) {
    ...
    TCreateDbParams typedOther = (TCreateDbParams)other;
