...
public class TUseDbParams implements org.apache.thrift.TBase<TUseDbParams, TUseDbParams._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TUseDbParams other) {
    ...
    TUseDbParams typedOther = (TUseDbParams)other;
