...
public class TRuntimeProfileNode implements org.apache.thrift.TBase<TRuntimeProfileNode, TRuntimeProfileNode._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.EVENT_SEQUENCES};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.counters = new ArrayList<TCounter>(_list16.size);
                for (int _i17 = 0; _i17 < _list16.size; ++_i17)
                {
                  TCounter _elem18; // required
                  _elem18 = new TCounter();
                  _elem18.read(iprot);
                  struct.counters.add(_elem18);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.info_strings = new HashMap<String,String>(2*_map19.size);
                for (int _i20 = 0; _i20 < _map19.size; ++_i20)
                {
                  ...
                  struct.info_strings.put(_key21, _val22);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.info_strings_display_order = new ArrayList<String>(_list23.size);
                for (int _i24 = 0; _i24 < _list23.size; ++_i24)
                {
                  String _elem25; // required
                  _elem25 = iprot.readString();
                  struct.info_strings_display_order.add(_elem25);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.child_counters_map = new HashMap<String,Set<String>>(2*_map26.size);
                for (int _i27 = 0; _i27 < _map26.size; ++_i27)
                {
                  ...
                  struct.child_counters_map.put(_key28, _val29);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.event_sequences = new ArrayList<TEventSequence>(_list33.size);
                for (int _i34 = 0; _i34 < _list33.size; ++_i34)
                {
                  TEventSequence _elem35; // required
                  _elem35 = new TEventSequence();
                  _elem35.read(iprot);
                  struct.event_sequences.add(_elem35);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRuntimeProfileNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.counters != null) {
        oprot.writeFieldBegin(COUNTERS_FIELD_DESC);
        {
          ...
          for (TCounter _iter36 : struct.counters)
          {
            _iter36.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.info_strings != null) {
        oprot.writeFieldBegin(INFO_STRINGS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter37 : struct.info_strings.entrySet())
          {
      ...
      if (struct.info_strings_display_order != null) {
        oprot.writeFieldBegin(INFO_STRINGS_DISPLAY_ORDER_FIELD_DESC);
        {
          ...
          for (String _iter38 : struct.info_strings_display_order)
          {
      ...
      if (struct.child_counters_map != null) {
        oprot.writeFieldBegin(CHILD_COUNTERS_MAP_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Set<String>> _iter39 : struct.child_counters_map.entrySet())
          {
            oprot.writeString(_iter39.getKey());
            {
              oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, _iter39.getValue().size()));
      ...
      if (struct.event_sequences != null) {
        if (struct.isSetEvent_sequences()) {
          oprot.writeFieldBegin(EVENT_SEQUENCES_FIELD_DESC);
          {
            ...
            for (TEventSequence _iter41 : struct.event_sequences)
            {
              _iter41.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class TRuntimeProfileNodeTupleScheme extends TupleScheme<TRuntimeProfileNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TRuntimeProfileNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.num_children);
      {
        ...
        for (TCounter _iter42 : struct.counters)
        {
          _iter42.write(oprot);
        }
      }
      ...
      oprot.writeBool(struct.indent);
      {
        ...
        for (Map.Entry<String, String> _iter43 : struct.info_strings.entrySet())
        {
      ...
      }
      {
        ...
        for (String _iter44 : struct.info_strings_display_order)
        {
      ...
      }
      {
        ...
        for (Map.Entry<String, Set<String>> _iter45 : struct.child_counters_map.entrySet())
        {
      ...
      if (struct.isSetEvent_sequences()) {
        {
          ...
          for (TEventSequence _iter47 : struct.event_sequences)
          {
            _iter47.write(oprot);
          }
        }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TRuntimeProfileNode struct) throws org.apache.thrift.TException {
      ...
      struct.setNum_childrenIsSet(true);
      {
        ...
        struct.counters = new ArrayList<TCounter>(_list48.size);
        for (int _i49 = 0; _i49 < _list48.size; ++_i49)
        {
          TCounter _elem50; // required
          _elem50 = new TCounter();
          _elem50.read(iprot);
          struct.counters.add(_elem50);
        }
      }
      struct.setCountersIsSet(true);
      struct.metadata = iprot.readI64();
      ...
      struct.setIndentIsSet(true);
      {
        ...
        struct.info_strings = new HashMap<String,String>(2*_map51.size);
        for (int _i52 = 0; _i52 < _map51.size; ++_i52)
        {
          ...
          struct.info_strings.put(_key53, _val54);
        }
      }
      struct.setInfo_stringsIsSet(true);
      {
        ...
        struct.info_strings_display_order = new ArrayList<String>(_list55.size);
        for (int _i56 = 0; _i56 < _list55.size; ++_i56)
        {
          String _elem57; // required
          _elem57 = iprot.readString();
          struct.info_strings_display_order.add(_elem57);
        }
      }
      struct.setInfo_strings_display_orderIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map58 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.SET, iprot.readI32());
        struct.child_counters_map = new HashMap<String,Set<String>>(2*_map58.size);
        for (int _i59 = 0; _i59 < _map58.size; ++_i59)
        {
          String _key60; // required
          Set<String> _val61; // required
          ...
          struct.child_counters_map.put(_key60, _val61);
        }
      }
      struct.setChild_counters_mapIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.event_sequences = new ArrayList<TEventSequence>(_list65.size);
          for (int _i66 = 0; _i66 < _list65.size; ++_i66)
          {
            TEventSequence _elem67; // required
            _elem67 = new TEventSequence();
            _elem67.read(iprot);
            struct.event_sequences.add(_elem67);
          }
        }
        struct.setEvent_sequencesIsSet(true);
      }
