...
public class TSlotRef implements org.apache.thrift.TBase<TSlotRef, TSlotRef._Fields>, java.io.Serializable, Cloneable {
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case SLOT_ID:
      return Integer.valueOf(getSlot_id());
  ...
  public int compareTo(TSlotRef other) {
    ...
    TSlotRef typedOther = (TSlotRef)other;

    lastComparison = Boolean.valueOf(isSetSlot_id()).compareTo(typedOther.isSetSlot_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSlot_id()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.slot_id, typedOther.slot_id);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
