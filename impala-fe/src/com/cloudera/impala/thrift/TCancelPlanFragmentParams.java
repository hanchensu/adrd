...
public class TCancelPlanFragmentParams implements org.apache.thrift.TBase<TCancelPlanFragmentParams, TCancelPlanFragmentParams._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new TCancelPlanFragmentParamsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TCancelPlanFragmentParamsTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.FRAGMENT_INSTANCE_ID};
   ...
   * @see ImpalaInternalServiceVersion
   */
  public TCancelPlanFragmentParams setProtocol_version(ImpalaInternalServiceVersion protocol_version) {
    this.protocol_version = protocol_version;
    return this;
  }
  ...
  public TCancelPlanFragmentParams setFragment_instance_id(com.cloudera.impala.thrift.TUniqueId fragment_instance_id) {
  ...
  public int compareTo(TCancelPlanFragmentParams other) {
    ...
    TCancelPlanFragmentParams typedOther = (TCancelPlanFragmentParams)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TCancelPlanFragmentParams(");
    boolean first = true;
  ...
  private static class TCancelPlanFragmentParamsStandardSchemeFactory implements SchemeFactory {
    public TCancelPlanFragmentParamsStandardScheme getScheme() {
      return new TCancelPlanFragmentParamsStandardScheme();
    }
  }

  private static class TCancelPlanFragmentParamsStandardScheme extends StandardScheme<TCancelPlanFragmentParams> {
  ...
  private static class TCancelPlanFragmentParamsTupleSchemeFactory implements SchemeFactory {
    public TCancelPlanFragmentParamsTupleScheme getScheme() {
      return new TCancelPlanFragmentParamsTupleScheme();
    }
  }

  private static class TCancelPlanFragmentParamsTupleScheme extends TupleScheme<TCancelPlanFragmentParams> {
