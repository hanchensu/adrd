...
public class THdfsScanNode implements org.apache.thrift.TBase<THdfsScanNode, THdfsScanNode._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(THdfsScanNode other) {
    ...
    THdfsScanNode typedOther = (THdfsScanNode)other;
