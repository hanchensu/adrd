...
public class TUpdateStateResponse implements org.apache.thrift.TBase<TUpdateStateResponse, TUpdateStateResponse._Fields>, java.io.Serializable, Cloneable {
  ...
  public List<TTopicUpdate> topic_updates; // required
  ...
  public TUpdateStateResponse(
    ...
    List<TTopicUpdate> topic_updates)
  {
    this();
    this.status = status;
  ...
  public TUpdateStateResponse(TUpdateStateResponse other) {
    ...
    if (other.isSetTopic_updates()) {
      List<TTopicUpdate> __this__topic_updates = new ArrayList<TTopicUpdate>();
      for (TTopicUpdate other_element : other.topic_updates) {
        __this__topic_updates.add(new TTopicUpdate(other_element));
      }
  ...
  public java.util.Iterator<TTopicUpdate> getTopic_updatesIterator() {
    return (this.topic_updates == null) ? null : this.topic_updates.iterator();
  }

  public void addToTopic_updates(TTopicUpdate elem) {
    if (this.topic_updates == null) {
      this.topic_updates = new ArrayList<TTopicUpdate>();
    }
    this.topic_updates.add(elem);
  }

  public List<TTopicUpdate> getTopic_updates() {
    return this.topic_updates;
  }

  public TUpdateStateResponse setTopic_updates(List<TTopicUpdate> topic_updates) {
    this.topic_updates = topic_updates;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case TOPIC_UPDATES:
      if (value == null) {
        ...
        setTopic_updates((List<TTopicUpdate>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.topic_updates = new ArrayList<TTopicUpdate>(_list50.size);
                for (int _i51 = 0; _i51 < _list50.size; ++_i51)
                {
                  TTopicUpdate _elem52; // required
                  _elem52 = new TTopicUpdate();
                  _elem52.read(iprot);
                  struct.topic_updates.add(_elem52);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TUpdateStateResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.topic_updates != null) {
        oprot.writeFieldBegin(TOPIC_UPDATES_FIELD_DESC);
        {
          ...
          for (TTopicUpdate _iter53 : struct.topic_updates)
          {
            _iter53.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class TUpdateStateResponseTupleScheme extends TupleScheme<TUpdateStateResponse> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TUpdateStateResponse struct) throws org.apache.thrift.TException {
      ...
      struct.status.write(oprot);
      {
        ...
        for (TTopicUpdate _iter54 : struct.topic_updates)
        {
          _iter54.write(oprot);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TUpdateStateResponse struct) throws org.apache.thrift.TException {
      ...
      struct.setStatusIsSet(true);
      {
        ...
        struct.topic_updates = new ArrayList<TTopicUpdate>(_list55.size);
        for (int _i56 = 0; _i56 < _list55.size; ++_i56)
        {
          TTopicUpdate _elem57; // required
          _elem57 = new TTopicUpdate();
          _elem57.read(iprot);
          struct.topic_updates.add(_elem57);
        }
      }
      struct.setTopic_updatesIsSet(true);
    }
