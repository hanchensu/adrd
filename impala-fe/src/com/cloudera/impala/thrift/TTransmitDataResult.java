...
public class TTransmitDataResult implements org.apache.thrift.TBase<TTransmitDataResult, TTransmitDataResult._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new TTransmitDataResultStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TTransmitDataResultTupleSchemeFactory());
  }
  ...
  public TTransmitDataResult setStatus(com.cloudera.impala.thrift.TStatus status) {
    this.status = status;
    return this;
  }
  ...
  public int compareTo(TTransmitDataResult other) {
    ...
    TTransmitDataResult typedOther = (TTransmitDataResult)other;
  ...
  private static class TTransmitDataResultStandardScheme extends StandardScheme<TTransmitDataResult> {
  ...
  private static class TTransmitDataResultTupleScheme extends TupleScheme<TTransmitDataResult> {
