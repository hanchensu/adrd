...
public class TGetTablesResult implements org.apache.thrift.TBase<TGetTablesResult, TGetTablesResult._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TGetTablesResult other) {
    ...
    TGetTablesResult typedOther = (TGetTablesResult)other;
