...
public class TCreateOrAlterViewParams implements org.apache.thrift.TBase<TCreateOrAlterViewParams, TCreateOrAlterViewParams._Fields>, java.io.Serializable, Cloneable {
  ...
  public TTableName view_name; // required
  ...
  private _Fields optionals[] = {_Fields.COMMENT,_Fields.IF_NOT_EXISTS};
  ...
  public TCreateOrAlterViewParams(TCreateOrAlterViewParams other) {
    ...
    if (other.isSetView_name()) {
      this.view_name = new TTableName(other.view_name);
    }
  ...
  public TTableName getView_name() {
    return this.view_name;
  }

  public TCreateOrAlterViewParams setView_name(TTableName view_name) {
    this.view_name = view_name;
    return this;
  }
  ...
  public TCreateOrAlterViewParams setColumns(List<TColumnDef> columns) {
    this.columns = columns;
    return this;
  }
  ...
  public int compareTo(TCreateOrAlterViewParams other) {
    ...
    TCreateOrAlterViewParams typedOther = (TCreateOrAlterViewParams)other;

    lastComparison = Boolean.valueOf(isSetView_name()).compareTo(typedOther.isSetView_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetView_name()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.view_name, typedOther.view_name);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetOriginal_view_def()).compareTo(typedOther.isSetOriginal_view_def());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOriginal_view_def()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.original_view_def, typedOther.original_view_def);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetExpanded_view_def()).compareTo(typedOther.isSetExpanded_view_def());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExpanded_view_def()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.expanded_view_def, typedOther.expanded_view_def);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
        ...
        switch (schemeField.id) {
          case 1: // VIEW_NAME
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.view_name = new TTableName();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new ArrayList<TColumnDef>(_list80.size);
                for (int _i81 = 0; _i81 < _list80.size; ++_i81)
                {
                  TColumnDef _elem82; // required
                  _elem82 = new TColumnDef();
                  _elem82.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCreateOrAlterViewParams struct) throws org.apache.thrift.TException {
      ...
      if (struct.columns != null) {
        oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
        {
          ...
          for (TColumnDef _iter83 : struct.columns)
          {
            _iter83.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class TCreateOrAlterViewParamsTupleScheme extends TupleScheme<TCreateOrAlterViewParams> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TCreateOrAlterViewParams struct) throws org.apache.thrift.TException {
      ...
      struct.view_name.write(oprot);
      {
        ...
        for (TColumnDef _iter84 : struct.columns)
        {
          _iter84.write(oprot);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TCreateOrAlterViewParams struct) throws org.apache.thrift.TException {
      ...
      struct.setView_nameIsSet(true);
      {
        ...
        struct.columns = new ArrayList<TColumnDef>(_list85.size);
        for (int _i86 = 0; _i86 < _list85.size; ++_i86)
        {
          TColumnDef _elem87; // required
          _elem87 = new TColumnDef();
          _elem87.read(iprot);
