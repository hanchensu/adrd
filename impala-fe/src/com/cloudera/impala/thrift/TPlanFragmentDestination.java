...
public class TPlanFragmentDestination implements org.apache.thrift.TBase<TPlanFragmentDestination, TPlanFragmentDestination._Fields>, java.io.Serializable, Cloneable {
  ...
  public TPlanFragmentDestination setFragment_instance_id(com.cloudera.impala.thrift.TUniqueId fragment_instance_id) {
    this.fragment_instance_id = fragment_instance_id;
    return this;
  }
  ...
  public TPlanFragmentDestination setServer(com.cloudera.impala.thrift.TNetworkAddress server) {
    this.server = server;
    return this;
  }
  ...
  public int compareTo(TPlanFragmentDestination other) {
    ...
    TPlanFragmentDestination typedOther = (TPlanFragmentDestination)other;
