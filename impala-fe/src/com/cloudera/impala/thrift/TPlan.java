...
public class TPlan implements org.apache.thrift.TBase<TPlan, TPlan._Fields>, java.io.Serializable, Cloneable {
  ...
  public TPlan(TPlan other) {
    if (other.isSetNodes()) {
      List<TPlanNode> __this__nodes = new ArrayList<TPlanNode>();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.nodes = new ArrayList<TPlanNode>(_list120.size);
                for (int _i121 = 0; _i121 < _list120.size; ++_i121)
                {
                  TPlanNode _elem122; // required
                  _elem122 = new TPlanNode();
                  _elem122.read(iprot);
                  struct.nodes.add(_elem122);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPlan struct) throws org.apache.thrift.TException {
      ...
      if (struct.nodes != null) {
        oprot.writeFieldBegin(NODES_FIELD_DESC);
        {
          ...
          for (TPlanNode _iter123 : struct.nodes)
          {
  ...
  private static class TPlanTupleScheme extends TupleScheme<TPlan> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TPlan struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (TPlanNode _iter124 : struct.nodes)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TPlan struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.nodes = new ArrayList<TPlanNode>(_list125.size);
        for (int _i126 = 0; _i126 < _list125.size; ++_i126)
        {
          TPlanNode _elem127; // required
          _elem127 = new TPlanNode();
          _elem127.read(iprot);
          struct.nodes.add(_elem127);
        }
      }
      struct.setNodesIsSet(true);
    }
