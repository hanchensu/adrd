...
public class QueryExplanation implements org.apache.thrift.TBase<QueryExplanation, QueryExplanation._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(QueryExplanation other) {
    ...
    if (isSetTextual()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.textual, typedOther.textual);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
