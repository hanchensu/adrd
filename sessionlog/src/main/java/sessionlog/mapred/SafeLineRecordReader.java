...
public class SafeLineRecordReader implements RecordReader<LongWritable, Text> {
	...
	public SafeLineRecordReader(JobConf job, FileSplit split) throws IOException {
	}
