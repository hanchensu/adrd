...
public abstract class BaseLineRecordReader implements
		RecordReader<LongWritable, Text> {

	private static final Log LOG = LogFactory.getLog(BaseLineRecordReader.class
			.getName());
	...
	public BaseLineRecordReader(Configuration job, FileSplit split)
			throws IOException {
	...
	public BaseLineRecordReader(InputStream in, long offset, long endOffset,
			int maxLineLength) {
	...
	public abstract void transform(Text value);
