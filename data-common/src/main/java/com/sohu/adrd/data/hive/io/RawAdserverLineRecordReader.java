...
public class RawAdserverLineRecordReader implements
		RecordReader<LongWritable, Text> {

	private static final Log LOG = LogFactory
			.getLog(RawAdserverLineRecordReader.class.getName());
	...
	public RawAdserverLineRecordReader(Configuration job, FileSplit split,
	...
	public RawAdserverLineRecordReader(InputStream in, long offset,
