...
public class RawCountinfoInputFormat extends FileInputFormat<LongWritable, Text>
{

	private static final Log LOG = LogFactory.getLog(RawCountinfoInputFormat.class);
