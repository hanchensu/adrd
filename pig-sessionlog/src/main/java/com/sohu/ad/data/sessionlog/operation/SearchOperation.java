...
public class SearchOperation implements org.apache.thrift.TBase<SearchOperation, SearchOperation._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SearchOperation");
  ...
  private static final org.apache.thrift.protocol.TField DOMAIN_FIELD_DESC = new org.apache.thrift.protocol.TField("domain", org.apache.thrift.protocol.TType.STRING, (short)8);
  ...
  private static final org.apache.thrift.protocol.TField FLAG_FIELD_DESC = new org.apache.thrift.protocol.TField("flag", org.apache.thrift.protocol.TType.BYTE, (short)10);
  ...
  static {
    schemes.put(StandardScheme.class, new SearchOperationStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SearchOperationTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.YYID,_Fields.SOHUPASS,_Fields.SUV,_Fields.IP,_Fields.USERAGENT,_Fields.REGION,_Fields.TIMESTAMP,_Fields.DOMAIN,_Fields.KEYWORDS,_Fields.FLAG,_Fields.STATUS_CODE};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SearchOperation.class, metaDataMap);
  }
   ...
   */
  public SearchOperation(SearchOperation other) {
  ...
  public SearchOperation deepCopy() {
  ...
  public SearchOperation setYyid(String yyid) {
    this.yyid = yyid;
    return this;
  }
  ...
  public SearchOperation setSohupass(String sohupass) {
  ...
  public SearchOperation setSuv(String suv) {
    this.suv = suv;
    return this;
  }
  ...
  public SearchOperation setIp(String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public SearchOperation setRegion(String region) {
    this.region = region;
    return this;
  }
  ...
  public SearchOperation setTimestamp(long timestamp) {
  ...
  public SearchOperation setDomain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public SearchOperation setKeywords(String keywords) {
  ...
  public SearchOperation setFlag(byte flag) {
    this.flag = flag;
    setFlagIsSet(true);
    return this;
  }
  ...
  public SearchOperation setStatusCode(int statusCode) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SearchOperation)
      return this.equals((SearchOperation)that);
    return false;
  }

  public boolean equals(SearchOperation that) {
    if (that == null)
      return false;
  ...
  public int compareTo(SearchOperation other) {
    ...
    SearchOperation typedOther = (SearchOperation)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SearchOperation(");
    boolean first = true;
  ...
  private static class SearchOperationStandardSchemeFactory implements SchemeFactory {
    public SearchOperationStandardScheme getScheme() {
      return new SearchOperationStandardScheme();
    }
  }

  private static class SearchOperationStandardScheme extends StandardScheme<SearchOperation> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SearchOperation struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SearchOperation struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SearchOperationTupleSchemeFactory implements SchemeFactory {
    public SearchOperationTupleScheme getScheme() {
      return new SearchOperationTupleScheme();
    }
  }

  private static class SearchOperationTupleScheme extends TupleScheme<SearchOperation> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SearchOperation struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SearchOperation struct) throws org.apache.thrift.TException {
